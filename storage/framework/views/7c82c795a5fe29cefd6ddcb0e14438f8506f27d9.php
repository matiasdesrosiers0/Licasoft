			...
			<table class="table table-striped table-bordered table-condensed table-hover">
               ...
               <?php foreach($convenios as $cat): ?>
				<tr>
					...
					<td><?php echo e($cat->direccion); ?></td>
					<td><?php echo e($cat->telefono); ?></td>
					<td>
						<a href="<?php echo e(URL::action('ConveniosController@edit',$cat->id)); ?>"><button class="btn btn-info">Editar</button></a>
                         <a href="" data-target="#modal-delete-<?php echo e($cat->id); ?>" data-toggle="modal"><button class="btn btn-danger">Eliminar</button></a>
					</td>
				</tr>
