<?php $__env->startSection('contenido'); ?>
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			...
			<?php echo Form::open(array('url'=>'licasoft/movil','method'=>'POST','autocomplete'=>'off')); ?>
			...
			<div class="form-group">
				...
				<option value="<?php echo e($ambulancia['id_ambulancia']); ?>"> <?php echo e($ambulancia->modelo); ?></option>
				<?php endforeach; ?>
				</select>
		...
		<div class="form-group">
				...
				<option value="<?php echo e($profesional['nombre']); ?>"> <?php echo e($profesional['nombre']); ?></option>
				<?php endif; ?>
				<?php endforeach; ?>
				</select>
            </div>
