...
role="dialog" tabindex="-1" id="modal-delete-<?php echo e($cat->id_ficha); ?>">
	<?php echo e(Form::Open(array('action'=>array('FichaPendienteController@destroy',$cat->id_ficha),'method'=>'delete'))); ?>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="form-group">
                ...
                <!-- /btn-group -->
                <input  value="<?php echo e($cat->hora_salida_qth); ?>" readonly name="hora_salida_qth" id="hora_salida_qth" type="text" class="form-control">
              </div>
			  <br>
			...
			<div class="form-group">
                ...
                <!-- /btn-group -->
                <input  value="<?php echo e($cat->hora_llegada_qth); ?>" readonly name="hora_llegada_qth" id="hora_llegada_qth" type="text" class="form-control">
              </div>
			  <br>
			...
			<div class="form-group">
                ...
                <!-- /btn-group -->
                <input  value="<?php echo e($cat->hora_420); ?>" readonly id="hora_420" type="text" class="form-control">
              </div>
          ...
          <div class="box box-solid">
            ...
            <div class="box-body">
              <dl class="dl-horizontal">
				...
				<dd><h4><?php echo e($cat->estado_movil); ?></4></dd>
							<dd>------------------------------------------------------------------------------</dd>
			  ...
			  <dt><h4>ID Ficha</4></dt>
				...
				<dd><h4><?php echo e($cat->hora_despacho); ?></4></dd>
				<dt><h4>Hora llegada:</4></dt>
				<dd><h4><?php echo e($cat->hora_llegada); ?></4></dd>
				<dt><h4>Hora salida QTH</4></dt>
				<dd><h4><?php echo e($cat->hora_salida_qth); ?></4></dd>
				<dt><h4>Hora llegada QTH</4></dt>
				<dd><h4><?php echo e($cat->hora_llegada_qth); ?></4></dd>
				<dt><h4>Hora 420</4></dt>
				<dd><h4><?php echo e($cat->hora_420); ?></4></dd>
