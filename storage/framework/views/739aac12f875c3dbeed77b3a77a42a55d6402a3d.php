<?php $__env->startSection('contenido'); ?>
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			...
			<?php echo Form::model($ambulancias,['method'=>'PATCH','route'=>['licasoft.movil.ambulancias.update',$ambulancias->id_ambulancia]]); ?>
            ...
            <div class="form-group">
            	<label for="descripcion">Combustible</label>
            	<input type="text" name="combustible" class="form-control" value="<?php echo e($ambulancias->combustible); ?>" placeholder="Combustible...">
            </div>
            <div class="form-group">
