...
<h3 id="horeja"></h3>
			...
			{!!Form::model($ficha,['method'=>'PATCH','route'=>['licasoft.fichaPendiente.update',$ficha->id_ficha]])!!}
            {{Form::token()}}
			
        <br>
<label for="nombre">Hora Despacho</label>
			<div class="input-group">
			@if ($ficha->hora_despacho  == 000000)
			...
			@endif
                <!-- /btn-group -->
                <input  id="hora_despacho" readonly name="hora_despacho" value="{{$ficha->hora_despacho}}" type="text" class="form-control">
              </div>

<br>
			  <label for="nombre">Hora llegada</label>
			<div class="input-group">
			@if ($ficha->hora_llegada  == 000000)
			  <div class="input-group-btn">
                  <button type="button" onclick="getElementById('hora_llegada').value = getElementById('horeja').innerHTML" class="btn btn-info btn-flat">Marcar Hora</button>
								...
								@endif
                <!-- /btn-group -->
                <input  id="hora_llegada" readonly name="hora_llegada" value="{{$ficha->hora_llegada}}" type="text" class="form-control">
              </div>
			  <br>
			   <label for="nombre">Hora Salida QTH</label>
			<div class="input-group">
			@if ($ficha->hora_salida_qth  == 000000)
			  <div class="input-group-btn">
                  <button type="button" onclick="getElementById('hora_salida_qth').value = getElementById('horeja').innerHTML" class="btn btn-info btn-flat">Marcar Hora</button>
								...
								@endif
                <!-- /btn-group -->
                <input  value="{{$ficha->hora_salida_qth}}" readonly name="hora_salida_qth" id="hora_salida_qth" type="text" class="form-control">
              </div>
			  <br>
			  <label for="nombre">Hora Llegada QTH</label>
			<div class="input-group">
			@if ($ficha->hora_llegada_qth  == 000000)
			  <div class="input-group-btn">
                  <button type="button" onclick="getElementById('hora_llegada_qth').value = getElementById('horeja').innerHTML" class="btn btn-info btn-flat">Marcar Hora</button>
								...
								@endif
                <!-- /btn-group -->
                <input  value="{{$ficha->hora_llegada_qth}}" readonly name="hora_llegada_qth" id="hora_llegada_qth" type="text" class="form-control">
              </div>
			  <br>
            ...
            <div class="form-group">
            	...
            	<input class="form-control" name="estado_movil"  value="{{$ficha->estado_movil}}" type="text" >
            </div>
			<br>
			<label for="nombre">Hora 420</label>
			<div class="input-group">
			@if ($ficha->hora_420  == 000000)
			  ...
			  <div class="input-group-btn">
                  <button type="button"  onclick="miFuncion()"  class="btn btn-info btn-flat">Marcar Hora</button>
								...
								@endif
                <!-- /btn-group -->
                <input  value="{{$ficha->hora_420}}" name="hora_420" readonly id="hora_420" type="text" class="form-control">
              </div>
			...
			<div class="input-group">
                ...
                <input  name="precio_tiempo_extra" readonly value="{{$ficha->precio_tiempo_extra}}" id="precio_tiempo_extra" type="text" class="form-control">
              </div>
