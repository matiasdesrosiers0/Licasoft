...
@section ('contenido')
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			...
			{!!Form::model($ambulancias,['method'=>'PATCH','route'=>['licasoft.movil.ambulancias.update',$ambulancias->id_ambulancia]])!!}
            {{Form::token()}}
            ...
            <div class="form-group">
            	...
            	<input type="text" name="combustible" class="form-control" value="{{$ambulancias->combustible}}" placeholder="Combustible...">
            </div>
            <div class="form-group">
