...
<!-- Modal -->
  ...
  <a href="http://localhost:8000/licasoft/"><button class="btn btn-block btn-danger">Volver</button></a> 
    ...
    {!!Form::open(array('url'=>'licasoft/fichaPeticion','method'=>'POST','autocomplete'=>'off'))!!}
  {{Form::token()}}
...
<h3 id="horeja"></h3>
    ...
    <img src="{{asset('img/LOGOLICA.png')}}" id="center">
   ...
   <div class="form-group">
    ...
    <div class="form-group">
        ...
        @if (Auth::user()->id == $paciente['id_convenio'])
...
<div class="form-group">
              ...
              <option value="{{ $ambulancia['kmxlitro'] }}"> -Ambulancia {{$ambulancia['id_ambulancia'] }} -Modelo {{$ambulancia['modelo'] }}</option>
        ...
        directionsService.route({
          ...
          if (status === 'OK') {
            ...
            for (var i = 0; i < route.legs.length; i++) {
              ...
              summaryPanel.innerHTML += '<h3 align="center">   DETALLE    DEL   TRASLADO ' +
                  '<h3>';
